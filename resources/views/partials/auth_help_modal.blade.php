<!-- Modal -->
<div class="modal fade" id="authHelperMddal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="container">
    <div class="row">
      <div class="col-sm-6 col-sm-offset-3 text-center">
        ...
        <br><br>
        <h1>How to login?</h1>
        <h2>how to get access to profile, events, forum and other good stuff</h2>
        <hr>
