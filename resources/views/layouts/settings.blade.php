...
<body id="settings-layout">
<div class="overlay"></div>
    @include('partials.layout_header')
    @include('partials.settings_header')
    <div class="container-fluid manage-wrapper">
       <div class="container inner-manage-wrapper">
           @include('partials.manage-sidebar')
           <div class="col-xs-12 col-sm-12 col-md-9 col-md-offset-1 col-lg-9 col-lg-offset-1 manage-content-wrapper">
