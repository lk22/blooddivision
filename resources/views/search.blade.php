...
<div class="overlay"></div>
	<div class="container-fluid search-wrapper" id="wrapper">
			...
			<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
				<form action="" method="post">
					<div class="input-group">
						...
						<input type="text" class="form-control search-input" value="Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
					...
					<div class="container results none">
			...
			<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
				<div class="row result">
    				<div class="media">
					  <div class="media-left media-middle">
					    <a href="#">
					      <img class="media-object" src="/images/covers/swtor_logo.png" alt="...">
					    </a>
					  </div>
				...
				<div class="row result">
    				<div class="media">
					  <div class="media-left media-middle">
					    <a href="#">
					      <img class="media-object" src="/images/covers/swtor_logo.png" height="50" width="50" alt="...">
					    </a>
					  </div>
					  <div class="media-body">
					    <h4 class="media-heading">Lorem Ipsum</h4>
